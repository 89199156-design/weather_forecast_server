...
def test_cams_probe_checks_only_hourly_sentinel_forecast_files_by_default():
    probe = load_module()
...
def test_cams_probe_forecast_hours_are_sorted_unique_and_bounded():
    ...
    assert probe.probe_forecast_hours(None, max_forecast_hour=24) == [0, 1, 24]
