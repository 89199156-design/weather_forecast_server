...
GFS, CAMS and ECMWF use one pinned Open-Meteo source tree and one Swift image.
Do not update the upstream baseline without updating this file and
`../UPSTREAM.md`.
...
- Imported for: the unified GFS, CAMS and ECMWF producer, Open-Meteo model
  readers, interpolation, weather-code logic and OM generation.
...
Before changing the vendored tree:
